...
$DbLink->query("INSERT INTO ".C_MAP_REGIONS_TBL." (serverIP,serverPort,regionMapTexture,locX,locY) ( SELECT serverIP, serverHttpPort, uuid , locX , locY FROM ".C_REGIONS_TBL." )");
