...
$DbLink->query("SELECT HomeRegionID FROM ".C_AGENTS_TBL." WHERE UserID='$_SESSION[USERID]'");
...
<table width="100%" height="425" border="0" align="center">
      ...
      ?>
			  ...
			  <table width="64%" height="19" border="0" align="center" cellpadding="1" cellspacing="3" bgcolor="#666666">
				<tr>
                  <td colspan="2" valign="top" bgcolor="#666666"><div align="center"><strong>Change Emailaddress </strong></div></td>
                </tr>
				<? if($ERRORS2){?>
                <tr>
				...
				<form name="form1" method="post" action="index.php?page=change">
                <tr>
                  <td valign="top" bgcolor="#FFFFFF">Old Emailaddress</td>
                  <td valign="top" bgcolor="#FFFFFF"><input type="text" size="40" value="<?=$oldemail?>" name="emailold"></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF">New Emailaddress </td>
